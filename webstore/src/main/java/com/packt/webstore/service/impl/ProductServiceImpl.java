...
public class ProductServiceImpl implements ProductService {
	...
	public List<Product> getProductsBCategory(String category) {
	...
	public List<Product> getProductsByManufacture(String manufacture) {
		// TODO Auto-generated method stub
		
		return productRepository.getProductsByManufacturer(manufacture);
	}
